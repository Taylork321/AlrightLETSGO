...
namespace GroupAssignmentREAL.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public CoursesController(School_DBContext context)
        {
            _context = context;
        }
        ...
        {
            ViewData["CourseNameSortParm"] = String.IsNullOrEmpty(sortOrder) ? "CourseName" : "";
            ViewData["TopicSortParm"] = sortOrder == "Topic" ? "topic_desc" : "Topic";
    ...
    public async Task<IActionResult> Details(string id)
        ...
        public async Task<IActionResult> Create([Bind("CourseId,CourseName,Topic,Description,Year,Semester,PreRequisites,Compulsory")] Course course)
        {
